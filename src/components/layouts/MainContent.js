 ...
 */}
            ...
            {/* <div className="col-lg-6 mb-4"> */}
                ...
                <div className="card-body">
                    ...
                    <div className="progress-bar bg-danger w-20" role="progressbar"  aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <h4 className="small font-weight-bold">Sales Tracking <span className="float-right">40%</span></h4>
                    <div className="progress mb-4">
                    <div className="progress-bar bg-warning w-40" role="progressbar"  aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    ...
                    <div className="progress mb-4">
                    <div className="progress-bar bg-info w-80" role="progressbar"  aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
